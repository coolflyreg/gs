...
--send_request("account_auth", { username = "gxtest", password = "123456" })
--send_request("account_auth_platform", { code="260", appkey="12306", platform="client",  username = "gxtest", userid = "1", token = "a0ab00e976a9d0e865e4e34w3" })
